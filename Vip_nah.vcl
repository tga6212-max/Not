...
local ka, ac, as, sa = false, false, false, true 
local lat = 0 
local spinAngle = 0
...
local b4 = cBtn("Fix Lag (Clean)", 112, Color3.fromRGB(255, 255, 0))
local b5 = cBtn("Chống (Anti-Stun/Chịu Đòn)", 148, Color3.fromRGB(0, 180, 255))
local al = false
